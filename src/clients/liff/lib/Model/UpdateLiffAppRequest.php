...
class UpdateLiffAppRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['view'])) {
            $instance->setview(\LINE\Clients\Liff\Model\UpdateLiffView::from_dict($data['view']));
        }
        if (isset($data['description'])) {
            $instance->setdescription($data['description']);
        }
        if (isset($data['features'])) {
            $instance->setfeatures(\LINE\Clients\Liff\Model\LiffFeatures::from_dict($data['features']));
        }
