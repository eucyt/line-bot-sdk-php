    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['contents'])) {
            ...
            foreach ($data['contents'] as $item) {
                $contents[] = \LINE\Clients\MessagingApi\Model\FlexComponent::from_dict($item);
            }
        ...
        if (isset($data['background'])) {
            $instance->setbackground(\LINE\Clients\MessagingApi\Model\FlexBoxBackground::from_dict($data['background']));
        }
