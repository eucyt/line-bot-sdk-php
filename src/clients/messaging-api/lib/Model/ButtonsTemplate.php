    ...
    */
    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['defaultAction'])) {
            $instance->setdefaultAction(\LINE\Clients\MessagingApi\Model\Action::from_dict($data['defaultAction']));
        }
        if (isset($data['actions'])) {
            $actions = [];
            foreach ($data['actions'] as $item) {
                $actions[] = \LINE\Clients\MessagingApi\Model\Action::from_dict($item);
            }
