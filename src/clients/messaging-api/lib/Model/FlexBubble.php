    ...
    */
    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['styles'])) {
            $instance->setstyles(\LINE\Clients\MessagingApi\Model\FlexBubbleStyles::from_dict($data['styles']));
        }
        if (isset($data['header'])) {
            $instance->setheader(\LINE\Clients\MessagingApi\Model\FlexBox::from_dict($data['header']));
        }
        if (isset($data['hero'])) {
            $instance->sethero(\LINE\Clients\MessagingApi\Model\FlexComponent::from_dict($data['hero']));
        }
        if (isset($data['body'])) {
            $instance->setbody(\LINE\Clients\MessagingApi\Model\FlexBox::from_dict($data['body']));
        }
        if (isset($data['footer'])) {
            $instance->setfooter(\LINE\Clients\MessagingApi\Model\FlexBox::from_dict($data['footer']));
        }
        if (isset($data['size'])) {
            $instance->setsize($data['size']);
        }
        if (isset($data['action'])) {
            $instance->setaction(\LINE\Clients\MessagingApi\Model\Action::from_dict($data['action']));
        }
