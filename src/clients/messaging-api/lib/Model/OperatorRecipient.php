    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['and'])) {
            ...
            foreach ($data['and'] as $item) {
                $and[] = \LINE\Clients\MessagingApi\Model\Recipient::from_dict($item);
            }
            $instance->setand($and);
        }
        if (isset($data['or'])) {
            ...
            foreach ($data['or'] as $item) {
                $or[] = \LINE\Clients\MessagingApi\Model\Recipient::from_dict($item);
            }
            $instance->setor($or);
        }
        if (isset($data['not'])) {
            $instance->setnot(\LINE\Clients\MessagingApi\Model\Recipient::from_dict($data['not']));
        }
