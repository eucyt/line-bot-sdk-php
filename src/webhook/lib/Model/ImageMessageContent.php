    ...
    */
    ...
    public static function from_dict(?array $data): ?self
    {
        ...
        if (isset($data['contentProvider'])) {
            $instance->setcontentProvider(\LINE\Webhook\Model\ContentProvider::from_dict($data['contentProvider']));
        }
        if (isset($data['imageSet'])) {
            $instance->setimageSet(\LINE\Webhook\Model\ImageSet::from_dict($data['imageSet']));
        }
